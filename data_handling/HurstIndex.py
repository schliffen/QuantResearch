...
Guide to use H index
The Hurst exponent can be used to distinguish three possible market regimes:

*** If H < 0.5, the time series is mean reverting or stationary. The log-price volatility increases at a slower rate
    compared to normal diffusion associated with geometric Brownian motion. In this case, the series displays what is
    known as antipersistence (long-term switching between high and low values in adjacent points)

*** If H > 0.5, the series displays trending behavior and it is characterized by the presence of persistent behavior
    (long-term positive autocorrelation i.e. high values are likely to follow high values)
